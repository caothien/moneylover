        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::text('name', '', array('class' => 'form-control', 'id' => 'name', 'maxlength' => '15')) !!}
                    ...
                    {!! Form::text('note', '', array('class' => 'form-control', 'id' => 'note', 'maxlength' => '35')) !!}
                    {!! Form::label('','Avatar', array('for' => 'exampleInputEmail1')) !!}     
                    {!! Form::file('image', array('accept' => 'image/*')) !!}
                    <p style="color:red;"><?php if (isset($errorsize)) {echo $errorsize;} ?></p>
                    <p></p>
